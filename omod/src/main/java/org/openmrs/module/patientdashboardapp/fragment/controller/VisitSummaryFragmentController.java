...
public class VisitSummaryFragmentController {
	...
	public SimpleObject getVisitSummaryDetails(
		...
		SimpleObject detail = SimpleObject.fromObject(visitDetail, ui, "providerName","history","diagnosis", "symptoms", "procedures", "investigations","physicalExamination","visitOutcome","internalReferral","externalReferral","otherInstructions");
