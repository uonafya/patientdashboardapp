        ...
        jq(".drug-name").on("focus.autocomplete", function () {
            ...
            jq(this).autocomplete({
                ...
                change: function (event, ui) {
                    ...
                    jq.getJSON('${ui.actionLink("patientdashboardapp", "clinicalNotes", "getDosageRoutes")}').success(function (data) {
                        var dosageRoute = jq.map(data, function (dosageRoute) {
                            return new DosageRoute({
                                id: dosageRoute.id,
                                label: dosageRoute.name
                            })
                        });
                        console.log(dosageRoute);
                        console.log("date===>" + data)
                        prescription.drug().dosageRouteOpts(dosageRoute);
                    });
